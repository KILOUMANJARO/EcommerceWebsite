    ...
    <div className='productdisplay'>
        ...
        <div className="productdisplay-right">
            ...
            <div className="productdisplay-right-description">
                The definition long sleeve is a perfect shirt for the cooler days, and features a great design the even looks sick to non skiers. This classic crew neck Bella Canvas Long Sleeve T Shirt is carefully crafted with superior combed and ring-spun jersey cotton. A well-loved favorite classic unisex jersey that is comfortable for cooler weather days.
            </div>
